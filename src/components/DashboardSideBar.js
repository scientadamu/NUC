      ...
      <ul className="side-menu">
        ...
        <li className="slide">
          <a className="side-menu__item has-link" data-bs-toggle="slide" href="index.html">
            <svg xmlns="http://www.w3.org/2000/svg" className="side-menu__icon" enableBackground="new 0 0 24 24" viewBox="0 0 24 24">
        ...
        <li className="slide">
          <a className="side-menu__item" data-bs-toggle="slide" href="#">
            <svg xmlns="http://www.w3.org/2000/svg" className="side-menu__icon" enableBackground="new 0 24 24 24" viewBox="0 0 24 24">
