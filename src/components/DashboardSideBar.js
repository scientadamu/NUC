                  ...
                  <ul className="side-menu">
                    ...
                    <li className="slide">
                      <a className="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span className="side-menu__label">Forms</span><i className="angle fa fa-angle-right" />
                      </a>
                      <ul className="slide-menu">
                        ...
                        <li><a href="form-layouts.html" className="slide-item">Form Layouts</a></li>
                        ...
                        <li><a href="wysiwyag.html" className="slide-item">Form Editors</a></li>
                        <li><a href="form-editable.html" className="slide-item">Form editable</a></li>
                    ...
                    <li className="slide">
                      <a className="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span className="side-menu__label">Tables</span><i className="angle fa fa-angle-right" /></a>
                      <ul className="slide-menu">
                    ...
                    <li className="slide">
                      <a className="side-menu__item has-link" data-bs-toggle="slide" href="landing.html" target="_blank">
                        ...
                        <span className="side-menu__label">Landing</span>
                        <span className="badge badge-sm bg-secondary badge-hide">new</span>
                      </a>
                    </li>
                    <li className="slide">
                      <a className="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span className="side-menu__label">Charts</span><i className="angle fa fa-angle-right" /></a>
                      <ul className="slide-menu">
                    ...
                    <li className="slide">
                      <a className="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span className="side-menu__label">Icons</span><i className="angle fa fa-angle-right" /></a>
                      <ul className="slide-menu">
                    ...
                    <li className="slide">
                      <a className="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span className="side-menu__label">Maps</span><i className="angle fa fa-angle-right" /></a>
                      <ul className="slide-menu">
                    ...
                    <li className="slide">
                      <a className="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span className="side-menu__label">Sub-menus</span><i className="angle fa fa-angle-right" /></a>
                      <ul className="slide-menu">
                        <li className="side-menu-label1"><a href="javascript:void(0)">Sub-menus</a></li>
                        <li><a href="#" className="slide-item">Submenu-1</a></li>
                        <li className="sub-slide">
                          <a className="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span className="sub-side-menu__label">Submenu-2</span><i className="sub-angle fa fa-angle-right" /></a>
                          <ul className="sub-slide-menu">
                            <li><a className="sub-slide-item" href="#">Submenu-2.1</a></li>
                            <li><a className="sub-slide-item" href="#">Submenu-2.2</a></li>
                            <li className="sub-slide2">
                              <a className="sub-side-menu__item2" href="#" data-bs-toggle="sub-slide2"><span className="sub-side-menu__label2">Submenu-2.3</span><i className="sub-angle2 fa fa-angle-right" /></a>
                              <ul className="sub-slide-menu2">
                                <li><a href="#" className="sub-slide-item2">Submenu-2.3.1</a></li>
                                <li><a href="#" className="sub-slide-item2">Submenu-2.3.2</a></li>
                                <li><a href="#" className="sub-slide-item2">Submenu-2.3.3</a></li>
                              </ul>
                            </li>
                            <li><a className="sub-slide-item" href="#">Submenu-2.4</a></li>
                            <li><a className="sub-slide-item" href="#">Submenu-2.5</a></li>
                          </ul>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li className="slide">
                      <a className="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span className="side-menu__label">Apps</span><i className="angle fa fa-angle-right" />
                      </a>
                      <ul className="slide-menu">
                        <li className="side-menu-label1"><a href="javascript:void(0)">Apps</a></li>
                        <li><a href="calendar2.html" className="slide-item">Calendar</a></li>
                        <li><a href="chat.html" className="slide-item">Chat</a></li>
                        <li className="sub-slide">
                          <a className="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span className="sub-side-menu__label">E-Commerce</span><i className="sub-angle fa fa-angle-right" /></a>
                          <ul className="sub-slide-menu">
                            <li><a className="sub-slide-item" href="cart.html">Cart</a></li>
                            <li><a className="sub-slide-item" href="checkout.html">Checkout</a></li>
                            <li><a className="sub-slide-item" href="products.html">Products</a></li>
                            <li><a className="sub-slide-item" href="product-details.html">Product-Details</a></li>
                            <li><a className="sub-slide-item" href="wishlist.html">Wishlist</a></li>
                          </ul>
                        </li>
                        <li className="sub-slide">
                          <a className="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span className="sub-side-menu__label">File Manager</span><i className="sub-angle fa fa-angle-right" /></a>
                          <ul className="sub-slide-menu">
                            <li><a className="sub-slide-item" href="file-manager.html">Files</a></li>
                            <li><a className="sub-slide-item" href="file-manager-1.html">File Manager</a></li>
                            <li><a className="sub-slide-item" href="file-manager-2.html">File Details</a></li>
                          </ul>
                        </li>
                        <li className="sub-slide">
                          <a className="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span className="sub-side-menu__label">E-Mail</span><i className="sub-angle fa fa-angle-right" /></a>
                          <ul className="sub-slide-menu">
                            <li><a className="sub-slide-item" href="mail-inbox.html">Inbox</a></li>
                            <li><a className="sub-slide-item" href="mail-compose.html">Compose Mail</a></li>
                            <li><a className="sub-slide-item" href="mail-read.html">Read Mail</a></li>
                            <li><a className="sub-slide-item" href="mail-settings.html">Mail Settings</a></li>
                          </ul>
                        </li>
                        <li className="sub-slide">
                          <a className="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span className="sub-side-menu__label">Invoices</span><i className="sub-angle fa fa-angle-right" /></a>
                          <ul className="sub-slide-menu">
                            <li><a className="sub-slide-item" href="invoice-list.html">Invoice List</a></li>
                            <li><a className="sub-slide-item" href="invoice-details.html">Invoice Details</a></li>
                            <li><a className="sub-slide-item" href="invoice-create.html">Create Invoice</a></li>
                            <li><a className="sub-slide-item" href="invoice-timelog.html">Time Log Invoice</a></li>
                            <li><a className="sub-slide-item" href="invoice-edit.html">Edit Invoice</a></li>
                          </ul>
                        </li>
                        <li className="sub-slide">
                          <a className="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span className="sub-side-menu__label">Projects</span><i className="sub-angle fa fa-angle-right" /></a>
                          <ul className="sub-slide-menu">
                            <li><a className="sub-slide-item" href="projects.html">Projects</a></li>
                            <li><a className="sub-slide-item" href="projects-list.html">Projects List</a></li>
                            <li><a className="sub-slide-item" href="project-details.html">Project Details</a></li>
                            <li><a className="sub-slide-item" href="project-new.html">Project New</a></li>
                            <li><a className="sub-slide-item" href="project-edit.html">Edit Project</a></li>
                          </ul>
                        </li>
                        <li><a href="ticket-details.html" className="slide-item"><span className="side-menu__label">Tickets</span></a></li>
                        <li className="sub-slide">
                          <a className="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span className="sub-side-menu__label">Tasks</span><i className="sub-angle fa fa-angle-right" /></a>
                          <ul className="sub-slide-menu">
                            <li><a className="sub-slide-item" href="tasks-list.html">Task List</a></li>
                            <li><a className="sub-slide-item" href="task-edit.html">Edit Task</a></li>
                            <li><a className="sub-slide-item" href="task-create.html">Create Task</a></li>
                          </ul>
                        </li>
                        <li className="sub-slide">
                          <a className="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span className="sub-side-menu__label">Clients</span><i className="sub-angle fa fa-angle-right" /></a>
                          <ul className="sub-slide-menu">
                            <li><a className="sub-slide-item" href="clients.html">Clients</a></li>
                            <li><a className="sub-slide-item" href="client-create.html">Add Client</a></li>
                          </ul>
                        </li>
                      </ul>
                    </li>
                    <li className="slide">
                      <a className="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span className="side-menu__label">UI Elements</span><i className="angle fa fa-angle-right" />
                      </a>
                      <ul className="slide-menu">
                        <li className="side-menu-label1"><a href="javascript:void(0)">UI Elements</a></li>
                        <li><a href="alerts.html" className="slide-item">Alerts</a></li>
                        <li><a href="avatar.html" className="slide-item">Avatar</a></li>
                        ...
                        <li><a href="dropdown.html" className="slide-item">Dropdown</a></li>
                        ...
                        <li><a href="scroll.html" className="slide-item">Scroll</a></li>
                    ...
                    <li className="slide">
                      <a className="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span className="side-menu__label">Advanced UI</span><i className="angle fa fa-angle-right" />
                      </a>
                      <ul className="slide-menu">
                        <li className="side-menu-label1"><a href="javascript:void(0)">Advanced UI</a></li>
                        <li><a href="accordion.html" className="slide-item">Accordions</a></li>
                        <li><a href="carousel.html" className="slide-item">Carousel</a></li>
                        <li><a href="cards.html" className="slide-item">Cards</a></li>
                        <li><a href="counters.html" className="slide-item">Counters</a></li>
                        <li><a href="modal.html" className="slide-item">Modals</a></li>
                        ...
                        <li><a href="progress.html" className="slide-item">Progress Bars</a></li>
                        <li><a href="footers.html" className="slide-item">Footers</a></li>
                        <li><a href="users-list.html" className="slide-item">Users List</a></li>
                    ...
                    <li className="slide">
                      <a className="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span className="side-menu__label">Pages</span><i className="angle fa fa-angle-right" />
                      </a>
                      <ul className="slide-menu">
                        <li className="side-menu-label1"><a href="javascript:void(0)">Pages</a></li>
                        <li className="sub-slide">
                          <a className="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span className="sub-side-menu__label">Authentication</span><i className="sub-angle fa fa-angle-right" /></a>
                          <ul className="sub-slide-menu">
                            <li><a className="sub-slide-item" href="login.html">Sign In</a></li>
                            <li><a className="sub-slide-item" href="register.html">Sign Up</a></li>
                            <li><a className="sub-slide-item" href="forgot-password.html">Forgot Password</a></li>
                            <li><a className="sub-slide-item" href="lockscreen.html">Lockscreen</a></li>
                            <li><a className="sub-slide-item" href="construction.html">UnderConstruction</a></li>
                          </ul>
                        </li>
                        <li className="sub-slide">
                          <a className="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span className="sub-side-menu__label">Error Pages</span><i className="sub-angle fa fa-angle-right" /></a>
                          <ul className="sub-slide-menu">
                            <li><a className="sub-slide-item" href="404.html">404 Error</a></li>
                            <li><a className="sub-slide-item" href="500.html">500 Error</a></li>
                            <li><a className="sub-slide-item" href="501.html">501 Error</a></li>
                          </ul>
                        </li>
                        <li><a href="settings.html" className="slide-item">Settings</a></li>
                        ...
                        <li><a href="switcher.html" className="slide-item">Switcher</a></li>
                        <li><a href="terms.html" className="slide-item">Terms</a></li>
                        <li><a href="faq.html" className="slide-item">Faq's</a></li>
                        <li><a href="pricing.html" className="slide-item">Pricing</a></li>
                        <li className="sub-slide">
                          <a className="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span className="sub-side-menu__label">Blog</span><i className="sub-angle fa fa-angle-right" /></a>
                          <ul className="sub-slide-menu">
                            <li><a className="sub-slide-item" href="blog.html">Blog</a></li>
                            <li><a className="sub-slide-item" href="blog-details.html">Blog Details</a></li>
                            <li><a className="sub-slide-item" href="blog-edit.html">Edit Post</a></li>
                          </ul>
                        </li>
                      </ul>
                    </li>
                    <li className="slide">
                      <a className="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span className="side-menu__label">Utilities</span><i className="angle fa fa-angle-right" /></a>
                      <ul className="slide-menu">
                        <li className="side-menu-label1"><a href="javascript:void(0)">Utilities</a></li>
                        <li><a href="background.html" className="slide-item">Background</a></li>
                        <li><a href="border.html" className="slide-item">Border</a></li>
                        <li><a href="display.html" className="slide-item">Display</a></li>
                        <li><a href="flex.html" className="slide-item">Flex</a></li>
                        <li><a href="height.html" className="slide-item">Height</a></li>
                        <li><a href="margin.html" className="slide-item">Margin</a></li>
                        <li><a href="padding.html" className="slide-item">Padding</a></li>
                        <li><a href="position.html" className="slide-item">Position</a></li>
                        <li><a href="width.html" className="slide-item">Width</a></li>
                        <li><a href="opacity.html" className="slide-item">Opacity</a></li>
