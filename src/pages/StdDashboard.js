...
const StdDashboard =()=>{
    return(
      <div className="ltr app sidebar-mini">
          <div className="page">
                      ...
                      <div className="navbar navbar-collapse responsive-navbar p-0">
                        <div className="collapse navbar-collapse" id="navbarSupportedContent-4">
                          <div className="d-flex order-lg-2">
                            ...
                            {/* Theme-Layout */}
                            <div className="dropdown d-md-flex source-container">
                              <a className="nav-link icon shortcut-icn" data-bs-toggle="dropdown">
                              ...
                              <div className="dropdown-menu dropdown-menu-end dropdown-menu-arrow source-logo-menu pt-2 pb-2">
                                ...
                                <div className="px-2 pb-4 pt-2">
                                  <div className="row mb-2">
                                    ...
                                    <div className="col d-flex">
                                      <a href="mail-inbox.html" className="dropdown-menu-item text-muted source-logo-container">
                                  ...
                                  <div className="row mb-2">
                                    <div className="col d-flex">
                                      <a href="chat.html" className="dropdown-menu-item text-muted source-logo-container">
                                    ...
                                    <div className="col d-flex p-0">
                                      <a href="#" className="dropdown-menu-item text-muted source-logo-container">
                                        ...
                                        <span className="mt-1">Files</span>
                                      </a>
                                    </div>
                                    <div className="col d-flex">
                                      <a href="products.html" className="dropdown-menu-item text-muted source-logo-container">
                                  ...
                                  <div className="row">
                                    ...
                                    <div className="col d-flex">
                                      <a href="products.html" className="dropdown-menu-item text-muted source-logo-container">
                                        ...
                                        <span className="mt-1">Forms</span>
                                      </a>
                                    </div>
                                  </div>
                                </div>
                            ...
                            <div className="dropdown  d-flex shopping-cart">
                              <a href="javascript:void(0);" className="nav-link icon text-center" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <div className="drop-heading border-bottom">
                                  <div className="d-flex">
                                    ...
                                    <div className="ms-auto">
                                      <span className="xm-title badge bg-secondary text-white fw-normal fs-11 badge-pill"> <a href="javascript:void(0);" className="showall-text text-white">Remove All</a> </span>
                                    </div>
                                  </div>
                                </div>
                                <div className="header-dropdown-list cart-menu ps4 overflow-hidden">
                                  <a className="dropdown-item d-flex p-4" href="cart.html">
                                    <span className="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="../assets/images/ecommerce/1.jpg" />
                                  ...
                                  <a className="dropdown-item d-flex p-4" href="cart.html">
                                    <span className="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="../assets/images/ecommerce/2.jpg" />
                                    <div className="wp-60 cart-desc mt-1">
                                  ...
                                  <a className="dropdown-item d-flex p-4" href="cart.html">
                                    <span className="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="../assets/images/ecommerce/3.jpg" />
                                    <div className="wp-60 cart-desc mt-1">
                                  ...
                                  <a className="dropdown-item d-flex p-4" href="cart.html">
                                    <span className="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="../assets/images/ecommerce/4.jpg" />
                                    <div className="wp-60 cart-desc mt-1">
                                  ...
                                  <a className="dropdown-item d-flex p-4" href="cart.html">
                                    <span className="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="../assets/images/ecommerce/5.jpg" />
                                    <div className="wp-60 cart-desc mt-1">
                              ...
                              <div className="dropdown-menu dropdown-menu-end dropdown-menu-arrow" data-bs-popper="none">
                                <div className="drop-heading border-bottom">
                                  <div className="d-flex">
                                    ...
                                    <div className="ms-auto">
                                      <span className="xm-title badge bg-secondary text-white fw-normal fs-11 badge-pill"> <a href="javascript:void(0);" className="showall-text text-white">Clear</a> </span>
                                    </div>
                                  </div>
                                </div>
                                <div className="message-menu ps2 overflow-hidden">
                                  <a className="dropdown-item d-flex" href="chat.html">
                                    <span className="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="../assets/images/users/1.jpg" style={{background: 'url("../assets/images/users/1.jpg") center center'}} />
                            ...
                            <div className="dropdown d-md-flex profile-1">
                              <a href="#" data-bs-toggle="dropdown" className="nav-link pe-2 leading-none d-flex animate">
                                <span>
                                  <img src="../assets/images/faces/6.jpg" alt="profile-user" className="avatar  profile-user brround cover-image" />
                                </span>
                                <div className="text-center p-1 d-flex d-lg-none-max">
                                  <h6 className="mb-0" id="profile-heading">Elena<i className="user-angle ms-1 fa fa-angle-down " /></h6>
                                </div>
                              </a>
                              <div className="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
              ...
              <div className="sticky">
                ...
                <div className="app-sidebar">
                  ...
                  <div className="main-sidemenu">
                    ...
                    <div className="slide-right" id="slide-right"><svg className= 'color' xmlns="http://www.w3.org/2000/svg" fill="#7b8191" width={24} height={24} viewBox="0 0 24 24">
                            ...
                            <div className="table-responsive">
                              <table id="data-table" className="table text-nowrap mb-0 table-bordered">
                                <thead className="table-head">
                                  <tr>
                                    <th className="bg-transparent border-bottom-0 wp-15">STUDENTS NAME</th>
                                    <th className="bg-transparent border-bottom-0">COURSES TITLE</th>
                                    <th className="bg-transparent border-bottom-0">FACULTY</th>
                                    <th className="bg-transparent border-bottom-0">DELIVERY DATE</th>
